...
def main(xypath, trainedpath, coeff, win_len=10):
    ...
    np.savez(trainedpath + 'precison_recalls.npz', x, y)
...
# xypath, trainedpath
#'python_speech_features/coeff39/', 'python_speech_features/coeff39/GaussianHMM_8_states/', coeff=39

# 'GMMHMM_2_states_2_mix/',  'GMMHMM_4_states_2_mix/',
pathss = ['GMMHMM_2_states_2_mix/',  'GMMHMM_4_states_2_mix/', 'GMMHMM_8_states_2_mix/',  'GaussianHMM_2_states/',
'GMMHMM_2_states_4_mix/',  'GMMHMM_4_states_4_mix/',  'GMMHMM_8_states_4_mix/',  'GaussianHMM_4_states/',
'GMMHMM_2_states_8_mix/',  'GMMHMM_4_states_8_mix/',  'GMMHMM_8_states_8_mix/',  'GaussianHMM_8_states/']
for pat in pathss:
    main('/scratch/tina/python_speech_features/coeff39/', '/scratch/tina/python_speech_features/coeff39/' + pat, coeff=39, win_len=10)
